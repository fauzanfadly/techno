                            ...
                            <v-container>
                                ...
                                <v-row justify="end">
                                    <v-col cols="auto">
                                        <v-btn
                                            color="deep-orange"
                                            @click="() => $router.push({ name: 'admin-product-category-create' })"
                                        >
...
const headers = ref([
    ...
    },
    {
        ...
        key: 'mt_vendor.mt_manufacture_type.name',
        width: '18%',
    },
    {
        title: 'Actions',
...
const loadData = async ({ page }) => {
    ...
    await Request.get({
        ...
        errorMessage: `Failed when fetching product category`
    })
        .then(({ data }) => {
...
const editItem = (id) => {
    router.push({ name: 'admin-product-category-detail', params: { id } });
};
